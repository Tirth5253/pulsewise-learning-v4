...
import SwipeableCards, { type CardData } from "../../../components/SwipeableCards/SwipeableCards"
...
export default function LessonClient({ subjects, lessons, lesson, cards, subjectId, lessonId }: LessonClientProps) {
        ...
        {completedCards >= cards.length ? (
          <div className={styles.completionMessage}>
            ...
            <p className={styles.completionDescription}>
              Great job! You've completed all {cards.length} cards in this lesson.
            </p>
            <BackButton href={`/learning/${subjectId}`} label="Back to Lessons" />
          </div>
        ) : (
